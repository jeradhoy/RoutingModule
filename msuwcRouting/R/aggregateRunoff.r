...
AggregateRunoff <- function(ncFile, catchmentPolygons, runoffVar, useWeights=F, sumData=T, startDate=NULL, leapDays=F, by="day", fname=NULL, convertToDischarge=T, catchAreaField=setupList$catchAreaField){
