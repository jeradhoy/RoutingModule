...
flowCpp.1 <- RouteWaterCpp(streamDat = streamNet, Rsurf=sro,  Rsub=ssro, spinUpCycles=2, spinUpYears=10, debugMode=F, by="month", widthCoeffs=c(0.3, 0.6), manningN=.1, slopeMin=.01, aCoeffCoeff=40, beaverCoeff=1)
...
plot(flowCpp.1[[1]][, "21647"], type="l", col="red")
